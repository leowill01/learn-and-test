...
?available.genomes
# Install genome 
# BioManager::install(BSgenome.Celegans.UCSC.ce2)
# See which genomes are installed
installed.genomes()
# Assign genome to variable
genome_cel = BSgenome.Celegans.UCSC.ce2
genome_cel
```
...
genome_cel$chrI
# Rev strand
reverseComplement(genome_cel$chrI)
```

Retrieve the number of bases

```{r}
chr1 = genome_cel$chrI
length(chr1)
```
